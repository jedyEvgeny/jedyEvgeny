...
Создаю backend для web-сайтов. Основные технологии и ПО: Golang, Docker, GitHub Actions, SQL, Linux (Manjaro, Mint).
...
Ко мне можно обратиться рекрутеру IT-компании для предложения частичной или полной занятости на удалённой работе. 
...
У меня небольшой практический опыт, однако я быстро учусь и обладаю значительной технической и soft'овой насмотренностью. Это помогает мне находить нужную информацию и договариваться с людьми.
