...
У меня техническая насмотренность: например, понимаю разницу в мегабайте (1000 килобайт) и мебибайте (1024 кибибайт), если какой-то технологией не владею - то хотя бы в общих чертах понимаю что нужно сделать и где найти информацию которая поможет решить задачу. Понимаю пользу стандартной документации Golang и регулярно читаю новостные ТГ-каналы и Хабр в части новинок программирования. 

Если вы IT-рекрутер и вам подходит мой опыт, <a href="https://t.me/EvKly" target="_blank"> буду рад пообщаться.</a>
