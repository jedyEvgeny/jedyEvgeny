...
Создаю backend для web-сайтов. Основные технологии и ПО: Golang, Docker, GitHub Actions, SQL, Linux (Mangaro, Mint).
Также владею вспомогательными технологиями и ПО: Git (в терминале), HTML/CSS, Postman, sqlitebrowser и др.
Использую готовый фронт и иногда готовые тесты, чтобы написать бэкенд. Либо это чистый бек без привязки к фронтенду.

Ко мне можно обратиться рекрутеру IT-компании для предложения частичной или полной занятости. 
Люблю тесты для сокращения багов; быстро печатаю на кириллице и латинице; стараюсь максимально использовать стандартные пакеты, чтобы облегчить понимания кода сторонним разработчикам.

Не готов работать над проектом, если нужно писать фронт, т.к. это не моя специфика. Могу подсказать хороших специалистов по фронтенду.
...
У меня небольшой практический опыт, однако я быстро учусь и обладаю значительной технической и soft'овой насмотренностью. Это помогает мне находить нужную информацию и взаимодействовать с людьми на взаимовыгодных отношениях.
